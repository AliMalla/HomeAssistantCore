...
from homeassistant.components.mealie.services import (
    async_filter_recipes,
    async_filter_recipes_by_popularity,
)
...
async def test_filter_by_cooking_time():
    ...
    result = await async_filter_recipes(mock_hass, call)
...
async def test_filter_recipes_by_popularity():  # noqa: D103
    ...
    result = await async_filter_recipes_by_popularity(mock_hass, call)
